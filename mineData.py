...
# These functions dont work how they should, but labels are calculated after we get all the data so doesnt matter
...
def mine(repoPath, lang, start, end, repoName, batchSize):
    ...
    def mine_repo(repo, language, filename):
        ...
        # The label functions dont work because I didnt understand how python handles scope
        # It's okay though because we label the 10x engineers after getting all data later
